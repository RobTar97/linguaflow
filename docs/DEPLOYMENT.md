...
This architecture does not require a database ID, environment variable, or
third-party service. The first deployment provisions the Durable Object
namespace declared in `wrangler.jsonc`.
...
- `CLOUDFLARE_API_TOKEN`: an API token allowed to edit Workers;
