...
export default function ContributorPreview() {
  ...
  async function inspect(file: File) {
    ...
    if (file.size > PACK_LIMITS.archiveBytes) {
      setResult({ valid: false, issues: [{ severity: "error", code: "archive.size", path: "archive", message: "The archive exceeds 25 MiB." }] });
      return;
    }
